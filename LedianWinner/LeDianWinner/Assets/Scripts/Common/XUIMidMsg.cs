...
public class XUIMidMsg : MonoBehaviour
{
            ...
            if (instance == null)
            {
                ...
                if (instance == null)
                {
                    ...
                    if (uiRoot)
                    {
                        ...
                        obj.transform.position = uiRoot.transform.position;
    ...
    public static void QuickMsg(string msgStr)
    {
        Instance.OnInit();
        Instance.ShowMsg(msgStr);
    }
    ...
    public void OnInit()
    {
        if (!IsInit)
        {
            ...
            var msgTemplate = transform.Find("MsgTemplate");
            if (msgTemplate == null) {
                msgTemplate = transform;
            }
            if (msgTemplate)
            {
