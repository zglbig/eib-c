...
public class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        types.Add(typeof(Dictionary<Type, UnityEngine.Component>));
    ...
    static void GenerateCLRBindingByAnalysis()
    {
        ...
        using (System.IO.FileStream fs = new System.IO.FileStream("E:/LedianRelease/LedianWinnerHotfix.dll", System.IO.FileMode.Open, System.IO.FileAccess.Read))
        {
            domain.LoadAssembly(fs);
        }
